...
import { Modifier, CharacterMetadata, ContentBlock, genKey, BlockMapBuilder, EditorState, SelectionState } from 'draft-js';
...
var addSticker = (function (editorState, stickerId) {
  ...
  var afterRemovalContentState = Modifier.removeRange(currentContentState, currentSelectionState, 'backward'); // deciding on the postion to split the text
  ...
  var newContentStateAfterSplit = Modifier.setBlockType(insertionTargetBlock, insertionTargetSelection, 'sticker'); // creating a new ContentBlock including the entity with data

  var contentStateWithEntity = newContentStateAfterSplit.createEntity('sticker', 'IMMUTABLE', {
    id: stickerId
  });
  var entityKey = contentStateWithEntity.getLastCreatedEntityKey();
  var charDataOfSticker = CharacterMetadata.create({
    entity: entityKey
  });
  ...
  var contentStateWithSticker = Modifier.replaceWithFragment(newContentStateAfterSplit, insertionTargetSelection, fragment); // update editor state with our new state including the sticker

  var newState = EditorState.push(editorState, contentStateWithSticker, 'insert-fragment');
...
var removeSticker = (function (editorState, blockKey) {
  ...
  content = Modifier.removeRange(content, targetRange, 'backward'); // force to new selection
...
var cleanupSticker = function cleanupSticker(editorState, blockKey) {
  ...
  var withoutSticker = Modifier.setBlockType(content, targetRange, 'unstyled');
  var newState = EditorState.push(editorState, withoutSticker, 'remove-range');
...
var StickerSelect = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var stickerElements = data.map(function (sticker) {
      ...
      return /*#__PURE__*/React.createElement(StickerOption, {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      type: "button"
    }, this.props.selectButtonContent), /*#__PURE__*/React.createElement("div", {
      className: popoverClassName,
      onMouseEnter: this.onMouseEnter,
      onMouseLeave: this.onMouseLeave
    }, /*#__PURE__*/React.createElement("div", {
      className: theme.selectStickerList
    }, stickerElements.toList().toJS()), /*#__PURE__*/React.createElement("div", {
...
var index = (function (config) {
  ...
  var DecoratedSticker = function DecoratedSticker(props) {
    return /*#__PURE__*/React.createElement(Sticker, _extends({}, props, {
  ...
  var DecoratedStickerSelect = function DecoratedStickerSelect(props) {
    return /*#__PURE__*/React.createElement(StickerSelect, _extends({}, props, {
